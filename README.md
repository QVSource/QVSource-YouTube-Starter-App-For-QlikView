YouTube Starter App
===================
A template application showing how to get started using the [QVSource YouTube Connector](http://www.qvsource.com/wiki/YouTube-Connector-For-QlikView.ashx) for QlikView. 
